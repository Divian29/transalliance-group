...
export const Header = () => {
  ...
  return (
    <div style={{backgroundColor: "#122038"}} className={`flex flex-col justify-center ${isSticky ? "sticky-header" : ""}`}>
      <div className="flex justify-center items-center px-16 py-5 w-full max-md:px-5 max-md:max-w-full">
        <div className="flex justify-between gap-5 w-full max-w-[1239px] max-md:flex-wrap max-md:max-w-full">
          <div className="flex my-auto text-4xl font-bold text-neutral-700 cursor-pointer" style={{ fontFamily: 'cursive' }}
          >
            <img
            src={logo} />
          </div>
          ...
          <div className="text-white hover:text-black hover:bg-green-400  rounded-xl px-3 py-5 self-stretch my-auto cursor-pointer">
            ...
            <div className="text-white hover:text-black hover:bg-green-400  rounded-xl px-3 py-5 self-stretch my-auto cursor-pointer">Get Started <HiArrowSmallUp /></div>
          </div>
